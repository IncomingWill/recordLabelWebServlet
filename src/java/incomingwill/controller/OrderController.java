...
public class OrderController extends HttpServlet 
{
                             ...
                             HttpServletResponse response) 
    {
        ...
        else 
        {
            ...
            String email
                    = CookiesUtility.getCookieValue(cookies, "emailCookie");
            if (email.equals("")) 
            {
                user = new User();
                url = "/cart/user.jsp";
                                 ...
                                 HttpServletResponse response) 
    {
        ...
        // set the emailCookie in the user's browser at max age
        ...
        String from = "confirmation@incomingwillrecords.com";
        ...
        String body = 
            ...
            "William Schaeffer\n" +
            "IncomingWill Records";
        
        boolean isBodyHTML = false;
        try 
        {
            EmailUtility.sendMail(to, from, subject, body, isBodyHTML);
        }
