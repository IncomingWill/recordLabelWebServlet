...
import incomingwill.utility.CookiesUtility;
...
public class CatalogController extends HttpServlet
{
                          ...
                          HttpServletResponse response)
    {
        ...
        if (user == null)
        {
            ...
            String emailAddress = CookiesUtility
                                  .getCookieValue(cookies, "emailCookie");
            ...
            else 
            {
                ...
                //if user for email isn't in the database, registration page
                if (user == null)
                {
                    return "/catalog/register.jsp";
                }
